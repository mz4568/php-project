...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    $suplier_name=mysqli_real_escape_string($db->link,$_POST['suplier_name']);
    if($suplier_name==''){
      $msg = "field must not be empty";
    }else{
      $query = "INSERT INTO suplier(suplier_name) values('$suplier_name')";
            ...
            <div class="card-content">
                ...
                <form method="POST" action="" enctype="multipart/form-data">
                   <div class="row">
                    ...
                    <a href="/inventory/suplierList.php" class="btn btn-danger">Back</a>
